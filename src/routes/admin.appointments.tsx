...
function AdminAppointmentsPage() {
  const { allBookings, loading } = useAdminData();
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-heading font-bold">Termine</h1>
          <p className="text-sm text-muted-foreground">Übersicht aller gebuchten Bewerbungs- und Mitarbeitertermine</p>
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-6 flex-1 min-w-[300px]">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-sm">
                        <div className="font-medium">{b.full_name || b.name || "Unbekannt"}</div>
                        <div className="text-xs text-muted-foreground">{b.email || "Keine E-Mail"}</div>
                      </div>
                    </div>
                    {b.phone && (
                      <div className="flex items-center gap-2">
